...
public class StudentInformationSystem {
	public static void main(String[] args) {
        // Create students
        Student student1 = new Student("Srija", "S001");
        Student student2 = new Student("nissi", "S002");
        Student student3 = new Student("tejaswi", "S003");
        Student student4 = new Student("nithya", "S004");
        Student student5 = new Student("pranitha", "S005");
        Student student6 = new Student("parmitha", "S006");
        Student student7 = new Student("nada", "S007");
        Student student8 = new Student("ramya", "S008");
